...
export default function AdminPage() {
  ...
  const quickLinks = [
    ...
    },
    {
      ...
      icon: ShoppingCart,
      href: "/admin/orders",
      desc: "متابعة طلبات العملاء",
    },
    {
      label: "الأقسام",
      icon: FolderTree,
      href: "/admin/categories",
      desc: "تنظيم أقسام المنتجات",
    },
    {
      label: "العروض",
      icon: Tag,
      href: "/admin/promotions",
      desc: "إدارة الخصومات والعروض",
    },
    {
      label: "الإعدادات",
      icon: Settings,
      href: "/admin/settings",
      desc: "إعدادات الموقع العامة",
    },
  ];
      ...
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-[#2C2420] to-[#4A5568] rounded-2xl p-6 text-white">
          ...
          <p className="text-white/80">
            إدارة متجر Aroma & Amor للعطور الفاخرة
          </p>
        </div>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className={`w-12 h-12 ${stat.color} rounded-xl flex items-center justify-center text-white group-hover:scale-110 transition-transform`}
                  >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link
                href="/admin/orders"
                className="text-sm text-[#2C2420] hover:underline"
              >
                عرض الكل
              </Link>
            </div>
                  ...
                  >
                    ...
                    <div className="text-left">
                      <p className="font-bold text-[#2C2420]">
                        {order.totalPrice.toFixed(3)} د.ك
                      </p>
                      <span
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <p className="text-sm text-gray-500 mt-1">
              {categories.filter((c) => c.isActive).length} قسم نشط
            </p>
          </div>
          <div className="bg-white rounded-2xl p-6 shadow-sm">
