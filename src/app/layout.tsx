  ...
  return (
    <html lang="ar" dir="rtl">
      <body className="antialiased">
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:right-4 focus:z-50 bg-primary text-primary-foreground px-4 py-2 rounded-md shadow-lg outline-none focus-visible:ring-ring focus-visible:ring-[3px]"
        >
          تخطي إلى المحتوى
        </a>
