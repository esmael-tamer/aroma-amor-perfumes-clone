        ...
        <SiteSettingsProvider>
          <OrdersProvider>
            <CartProvider>
              ...
              <a
                href="#main-content"
                className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:right-4 focus:z-[100] bg-primary text-primary-foreground px-4 py-2 rounded-md outline-none focus-visible:ring-2 focus-visible:ring-ring font-bold"
              >
