  ...
  return (
    <html lang="ar" dir="rtl">
      <body className="antialiased">
        <a
          href="#main-content"
          className="fixed top-4 right-4 z-50 -translate-y-24 focus:translate-y-0 bg-primary text-primary-foreground px-4 py-2 rounded-md shadow-lg transition-transform focus-visible:ring-ring focus-visible:ring-[3px] outline-none font-bold"
        >
