...
export const COMPANY_INFO = {
  ...
  description: 'نقدم لك أفضل العطور الفاخرة الأصلية 100% من قلب الكويت إلى جميع دول الخليج بأسعار تنافسية وجودة عالية.',
...
export const SEO_CONFIG = {
  ...
  description: 'أفخر العطور العالمية الأصلية 100% من الكويت. توصيل سريع لجميع دول الخليج. خصومات تصل إلى 88% مع ضمان استرجاع المال.',
  keywords: [
    'عطور',
    'عطور أصلية',
    'عطور الكويت',
