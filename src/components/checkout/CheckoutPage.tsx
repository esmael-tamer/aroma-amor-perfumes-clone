        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex gap-4">
              {step > 1 && (
                <Button type="button" onClick={() => setStep(prev => (prev - 1) as 1 | 2)} variant="outline"
              ...
              {step < 3 ? (
                <Button type="button" onClick={handleNextStep} className="flex-1 bg-gradient-to-r from-[#2C2420] to-[#4A5568] text-white py-6 rounded-full text-lg font-bold hover:shadow-xl transition-all"
                >
                  التالي
                </Button>
              ) : (
                <Button type="button" onClick={handleSubmitOrder} disabled={isSubmitting} className="flex-1 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white py-6 rounded-full text-lg font-bold hover:shadow-xl transition-all disabled:opacity-70"
                >
                  {isSubmitting ? (
