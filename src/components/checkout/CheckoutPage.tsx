...
🚚 الشحن: مجاني
  ...
  if (orderComplete) {
    return (
      <main id="main-content" className="min-h-screen bg-gradient-to-b from-[#E8EAED] to-white flex items-center justify-center p-4">
  ...
  return (
    <main id="main-content" className="min-h-screen bg-gradient-to-b from-[#E8EAED] to-white">
      {/* Header */}
