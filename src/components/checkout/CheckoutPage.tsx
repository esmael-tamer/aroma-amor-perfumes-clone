                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-4 rounded-xl border-2 ${errors.country ? 'border-red-500' : 'border-[#E8EAED]'} focus:border-[#2C2420] focus:outline-none transition-colors bg-white`}
