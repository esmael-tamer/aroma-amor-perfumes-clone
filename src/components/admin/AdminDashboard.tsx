                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-2">
                            <button
                              ...
                              className="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-[#2C2420] outline-none"
          ...
          <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-white rounded-3xl shadow-2xl z-50 p-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                ...
                className="text-gray-400 hover:text-gray-600 rounded-full focus-visible:ring-2 focus-visible:ring-[#2C2420] outline-none"
              >
              ...
              <div className="flex flex-wrap gap-2">
                {Object.entries(statusConfig).map(([key, value]) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-medium transition-all focus-visible:ring-2 focus-visible:ring-[#2C2420] outline-none ${
