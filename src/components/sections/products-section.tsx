    ...
    >
      <div className="container mx-auto px-4">
        ...
        <header className="text-center mb-16">
          ...
          >
            جميع منتجاتنا
            <span className="block text-[#9B8F85] text-3xl md:text-4xl mt-2">
              ({products.length} منتج)
            </span>
          </h2>
          <p className="text-lg text-[#4A5568] max-w-2xl mx-auto">
            اختر من بين مجموعة واسعة من العطور الفاخرة الأصلية المتاحة للشحن
            السريع لجميع دول الخليج
          </p>
        </header>
        ...
        {/* Products Count */}
        <p
          className="text-center mb-8 text-lg font-semibold text-[#4A5568]"
          aria-live="polite"
        >
        ...
        <div className="mt-20 relative overflow-hidden bg-gradient-to-br from-[#2C2420] via-[#4A5568] to-[#2C2420] rounded-[3rem] p-12 md:p-16 text-center text-white shadow-2xl">
          ...
          <div className="relative max-w-3xl mx-auto space-y-8">
            ...
            <p className="text-xl md:text-2xl text-white/90 leading-relaxed">
              خصومات تصل إلى{" "}
              <span className="text-amber-400 font-bold text-3xl">88%</span> على
              جميع المنتجات
              <br />
