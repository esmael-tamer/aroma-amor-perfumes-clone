...
const FeaturesSection = () => {
  return (
    <section className="py-20 bg-gradient-to-b from-white to-[#E8EAED]">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-[#E8EAED] hover:border-[#D4CCC4] hover:-translate-y-3"
              >
                {/* Icon Container */}
                <div className={`inline-flex p-5 rounded-2xl bg-gradient-to-br ${feature.color} mb-6 shadow-xl group-hover:scale-110 transition-transform duration-300`}>
                ...
                {/* Decorative Element */}
                <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-[#D4CCC4]/20 to-transparent rounded-bl-full opacity-0 group-hover:opacity-100 transition-opacity" />
                
                {/* Number Badge */}
                <div className="absolute -top-3 -right-3 bg-[#2C2420] text-white w-10 h-10 rounded-full flex items-center justify-center font-bold text-lg shadow-lg">
                  {index + 1}
                </div>
              </div>
            );
        ...
        <div className="mt-16 bg-white/60 backdrop-blur-sm rounded-3xl p-8 shadow-lg border-2 border-[#D4CCC4]/50">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8">
            ...
            <div className="h-12 w-px bg-[#D4CCC4]"></div>
            <div className="text-center">
