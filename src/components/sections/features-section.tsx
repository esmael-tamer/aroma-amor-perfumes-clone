...
const features: Feature[] = [
  {
    ...
    description:
      "جميع منتجاتنا أصلية ومضمونة من أفضل العلامات التجارية العالمية",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 bg-white/60 backdrop-blur-sm rounded-3xl p-8 shadow-lg border-2 border-[#D4CCC4]/50">
          <div className="text-center mb-6">
            <h3 className="text-2xl font-bold text-[#2C2420] mb-2">
              موثوق بنا في جميع أنحاء الخليج
            </h3>
            <p className="text-[#4A5568]">
              آلاف العملاء السعداء في الكويت والسعودية والإمارات وقطر والبحرين
              وعمان
            </p>
          </div>
          <div
          ...
          >
            <div className="text-center" role="listitem">
              <div className="text-4xl mb-2" aria-label="تقييم 5 نجوم">
                ⭐⭐⭐⭐⭐
              </div>
