                ...
                >
                  ...
                  <div className="flex flex-col items-end justify-between">
                    ...
                    <div className="flex items-center gap-1 bg-white rounded-full border-2 border-[#E8EAED] p-0.5 shadow-sm">
                      <div title={item.quantity <= 1 ? "الحد الأدنى للكمية" : `تقليل كمية ${item.product.nameAr}`}>
                        <button
                          type="button"
                      ...
                      <div title={item.quantity >= item.product.stock ? "الحد الأقصى للكمية المتوفرة" : `زيادة كمية ${item.product.nameAr}`}>
                        <button
                          type="button"
                          onClick={() => updateQuantity(item.product.id, item.quantity + 1)}
