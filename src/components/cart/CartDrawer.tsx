                ...
                >
                  ...
                  <div className="flex flex-col items-end justify-between">
                    <button
                      ...
                      className="text-red-400 hover:text-red-600 hover:bg-red-50 p-1.5 rounded-lg transition-all hover:scale-110 focus-visible:ring-2 focus-visible:ring-red-400 outline-none"
                    ...
                    <div className="flex items-center gap-1 bg-white rounded-full border-2 border-[#E8EAED] p-0.5 shadow-sm">
                      <button
                        ...
                        className="w-7 h-7 flex items-center justify-center rounded-full hover:bg-red-50 hover:text-red-500 transition-colors disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-transparent disabled:hover:text-inherit focus-visible:ring-2 focus-visible:ring-red-400 outline-none"
                      ...
                      <button
                        ...
                        className="w-7 h-7 flex items-center justify-center rounded-full hover:bg-emerald-50 hover:text-emerald-500 transition-colors disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-transparent disabled:hover:text-inherit focus-visible:ring-2 focus-visible:ring-emerald-500 outline-none"
